const y=(function(){let a=0;return function(){return(++a).toString()}})();function g(a,t="blank",e={icon:{type:"",content:""},duration:"",closeable:!1,theme:{type:"light",style:{background:"",color:"",stroke:""}}}){const o=y(),s=x(o,t,e),r=k(t,e),n=v(a);return s.appendChild(r),s.appendChild(n),e.closeable&&s.appendChild(T(s)),document.querySelector("wc-toast").appendChild(s),{id:o,type:t,message:a,...e}}function x(a,t,e){const{duration:o,theme:s}=e,r=document.createElement("wc-toast-item"),d=(window?.matchMedia&&window.matchMedia("(prefers-color-scheme: dark)"))?.matches?"dark":"light";if(r.setAttribute("type",t),r.setAttribute("duration",o||""),r.setAttribute("data-toast-item-id",a),r.setAttribute("theme",s?.type?s.type:d),s?.type==="custom"&&s?.style){const{background:m,stroke:c,color:w}=s.style;r.style.setProperty("--wc-toast-background",m),r.style.setProperty("--wc-toast-stroke",c),r.style.setProperty("--wc-toast-color",w)}return r}function k(a,t){const{icon:e}=t,o=document.createElement("wc-toast-icon");return o.setAttribute("type",e?.type?e.type:a),o.setAttribute("icon",e?.content&&e?.type==="custom"?e.content:""),e?.type==="svg"&&(o.innerHTML=e?.content?e.content:""),o}function v(a){const t=document.createElement("wc-toast-content");return t.setAttribute("message",a),t}function T(a){const t=document.createElement("wc-toast-close-button");return t.addEventListener("click",()=>{a.classList.add("dismiss-with-close-button")}),t}function l(a){return function(t,e){return g(t,a,e).id}}function i(a,t){return l("blank")(a,t)}i.loading=l("loading");i.success=l("success");i.error=l("error");i.dismiss=function(a){const t=document.querySelectorAll("wc-toast-item");for(const e of t){const o=e.getAttribute("data-toast-item-id");a===o&&e.classList.add("dismiss")}};i.promise=async function(a,t={loading:"",success:"",error:""},e){const o=i.loading(t.loading,{...e});try{const s=await a;return i.dismiss(o),i.success(t.success,{...e}),s}catch(s){return i.dismiss(o),i.error(t.error,{...e}),s}};class u extends HTMLElement{constructor(){super(),this.attachShadow({mode:"open"}),this.template=document.createElement("template"),this.template.innerHTML=u.template(),this.shadowRoot.append(this.template.content.cloneNode(!0))}connectedCallback(){this.setAttribute("role","status"),this.setAttribute("aria-live","polite"),this.position=this.getAttribute("position")||"top-center",this.arrangeToastPosition(this.position)}static get observedAttributes(){return["position"]}attributeChangedCallback(t,e,o){t==="position"&&(this.position=o,this.arrangeToastPosition(this.position))}arrangeToastPosition(t){const e=t.includes("top"),o={top:e&&0,bottom:!e&&0},s=t.includes("center")?"center":t.includes("right")?"flex-end":"flex-start",r=e?1:-1,n=e?"column-reverse":"column",m=window.getComputedStyle(document.querySelector("html")).getPropertyValue("scrollbar-gutter");this.style.setProperty("--wc-toast-factor",r),this.style.setProperty("--wc-toast-position",s),this.style.setProperty("--wc-toast-direction",n);const c=this.shadowRoot.querySelector(".wc-toast-container");c.style.top=o.top,c.style.bottom=o.bottom,c.style.right=m.includes("stable")&&"4px",c.style.justifyContent=s}static template(){return`
    <style>
      :host {
        --wc-toast-factor: 1;
    ...
    `}}customElements.define("wc-toast-close-button",b);export{u as WCToast,b as WCToastCloseButton,f as WCToastContent,h as WCToastIcon,p as WCToastItem,i as toast};
